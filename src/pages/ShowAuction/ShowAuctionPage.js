...
//     const auction = Campaign(props.query.address);
...
//       minimumContribution: auctionDetails[0],
//       approversCount: auctionDetails[2],
//       manager: auctionDetails[3],
//       highestBid: auctionDetails[4],
//       dataForSell: auctionDetails[5],
//       dataDescription: auctionDetails[6],
//       endTime: auctionDetails[7],
...
//   };
//   showData = (event) => {
//     this.setState({ displayBiddingDialog: true });
//   };
//   refundApprovers = async () => {
//     if (!this.props.auction.methods.getStatus().call()) {
//       for (let i = 0; i < this.props.contributors.length; i++) {
//         if (
//           this.props.contributors[i].toLowerCase() !=
//           this.props.highestBidder.toLowerCase()
//         ) {
//           let connectedAccount = this.props.contributors[i];
//           await this.props.auction.methods.withdrawBid(connectedAccount).send({
...
//               </div>
//               {!this.state.displayBiddingDialog && (
//                 <Button
...
//               variant="outlined"
//             >
//               <a style={{ color: "#D8DCF0" }}>Return To Auctions Main Screen</a>
//             </Button>
//           {/* </Link> */}
//         </div>
//       </Layout>
